...
namespace Demo.Fagsystem.Models.ViewModels
{
        ...
        XmlSchemaAnnotated? skipProp = null, PropertyRendererModel? InnerPropertyRendererModel = null, int? InnerPropertyModelInsertIndex = 0)
    {
        ...
        {
            string caption = CustomCaptionPattern != "" ? "" : TeksterUtils.GetCaption(Melding.SelectedSchema, Prop, fallbackToName, Melding.SelectedSprak) ?? "";
        ...
        public string GetDescription()
        {
            ...
            if (Prop == null) return
                    "<Prop=null>";
            return TeksterUtils.GetDescription(Melding.SelectedSchema, Prop);
        }
